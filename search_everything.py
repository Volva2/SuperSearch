...
everything_dll = ctypes.WinDLL("C:\\Users\\volva\\OneDrive\\Desktop\\Programming\\SuperSearch\\Everything-SDK\\dll\\Everything64.dll")
everything_dll.Everything_GetResultDateModified.argtypes = [ctypes.c_int, ctypes.c_ulonglong]
everything_dll.Everything_GetResultSize.argtypes = [ctypes.c_int, ctypes.c_ulonglong]
...
def search_everything(query: str):
    ...
    num_file_results = everything_dll.Everything_GetTotFileResults()
    num_folder_results = everything_dll.Everything_GetTotFolderResults()
